...
export default class Modal extends Component {
    ...
    beforeMount() {
        ...
        this.mount(this.render('div', this.className, 'afterbegin', modalLayout), '.wrapper');
    }
    ...
    mount(layuot, targetElement) {
        ...
        this.afterMount([
            {
                targetBtn: '.btn__close',
                subscribeFunctionName: 'closeModalWindow',
                subscribeFunctionBind: this.closeModalWindow.bind(this),
                eventName: 'click'
            },
            {
                targetBtn: '.btn__form_singUp',
                subscribeFunctionName: 'singUp',
                subscribeFunctionBind: this.singUp.bind(this),
                eventName: 'click'
            }
        ]);
    }
